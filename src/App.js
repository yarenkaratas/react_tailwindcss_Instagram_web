        ...
        <div className=" bg-white border px-[40px] pt-10 pb-6">
          ...
          <form className="grid gap-y-1.5">
            ...
            <button
              type="submit"
              disabled={!enable}
              className="h-[30px] rounded bg-brand font-semibold mt-1 text-white text-sm disabled:opacity-50"
            >
              Log In
            </button>
            ...
            <a
              href="#"
              className="text-xs flex justify-center items-center text-link"
            >
              Forget password?
            </a>
          </form>
